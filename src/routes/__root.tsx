...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://cbl-ten.vercel.app/" },
      ...
      { property: "og:image", content: "https://cbl-ten.vercel.app/metadata/opengraph-image.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "600" },
      // Twitter
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:url", content: "https://cbl-ten.vercel.app/" },
